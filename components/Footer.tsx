      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col justify-between gap-6 border-b border-white/10 pb-8 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-white/50">{t.footer.infoTitle}</p>
          </div>
          <a href={t.whatsappLink} target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#d7b56d] px-6 py-3 text-center font-black text-[#1f1a12]">WhatsApp</a>
        </div>
