    ...
    <section id="about" className="bg-[#fbf7ef] px-5 py-20 md:px-8">
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          ...
          <p className="mt-6 rounded-2xl border border-[#ead19b] bg-[#fff4da] p-5 leading-7 text-[#5a421f]">{t.productIntro.note}</p>
        </div>
        <div className="relative overflow-hidden rounded-[34px] bg-[#15110b] p-3 shadow-2xl shadow-[#8a6730]/20">
