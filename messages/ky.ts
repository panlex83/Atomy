export const ky = {
  ...
  nav: { product: "HemoHIM деген эмне?", ingredients: "Курамы", benefits: "Эмне үчүн HemoHIM тандашат", order: "Тапсырыс", faq: "FAQ" },

  hero: {
    title: "Atomy HemoHIM",
    subtitle: "Организмди күн сайын колдоого арналган кореялык продукт",
    ...
    cta: "WhatsApp аркылуу жазуу",
    secondary: "Кененирээк билүү",
    imageAlt: "HemoHIM өнімінің суреті",
  },

  productIntro: {
    title: "HemoHIM деген эмне?",
  ...
  ingredients: { title: "Курамы", text: "HemoHIM негізінде үш өсімдік компоненті бар:", items: ["Angelica Gigas", "Cnidium Officinale", "Paeonia Japonica"] },

  benefits: {
    title: "Эмне үчүн HemoHIM тандашат",
    items: [
  ...
  aboutAtomy: { title: "Atomy компаниясы жөнүндө", text: "Atomy — 2009 жылы құрылған Оңтүстік Корея компаниясы. Компания денсаулық, сұлулық, үй күтімі және күнделікті тұтыну тауарлары бағытында жұмыс істейді." },

  order: { title: "HemoHIM кантип заказ кылынат", steps: ["WhatsApp арқылы жазыңыз.", "Бар-жоғын және тапсырыс шарттарын нақтылаңыз.", "Өнім бойынша кеңес алыңыз.", "Тапсырысты ыңғайлы тәсілмен рәсімдеңіз."], cta: "WhatsApp арқылы тапсырыс беру" },
  ...
  contacts: { title: "Байланыштар", whatsapp: "+7 708 271 7008", email: "hemohim.atomy.ru@gmail.com", instagram: "hemohim.atomy.ru", tiktok: "hemohim.atomy.ru", facebook: "hemohim.atomy.ru@gmail.com" },

  footer: { infoTitle: "Маалымат" },
